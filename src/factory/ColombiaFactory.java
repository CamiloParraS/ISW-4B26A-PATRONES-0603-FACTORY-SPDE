...
public class ColombiaFactory extends DocumentProcessorFactory {
    ...
    private static final Map<DocumentType, List<FileFormat>> FORMAT_RULES = Map.of(
            DocumentType.ELECTRONIC_INVOICE, List.of(FileFormat.PDF, FileFormat.DOCX),
            DocumentType.LEGAL_CONTRACT, List.of(FileFormat.PDF, FileFormat.DOC, FileFormat.DOCX),
