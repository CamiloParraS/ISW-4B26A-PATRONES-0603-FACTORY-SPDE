...
public class ArgentinaFactory extends DocumentProcessorFactory {
    ...
    private static final Map<DocumentType, List<FileFormat>> FORMAT_RULES = Map.of(
            ...
            List.of(FileFormat.PDF, FileFormat.DOCX, FileFormat.CSV), DocumentType.LEGAL_CONTRACT,
            List.of(FileFormat.PDF, FileFormat.DOC, FileFormat.DOCX), DocumentType.FINANCIAL_REPORT,
            List.of(FileFormat.PDF, FileFormat.XLSX, FileFormat.CSV, FileFormat.TXT),
            DocumentType.DIGITAL_CERTIFICATE, List.of(FileFormat.PDF, FileFormat.DOCX),
            DocumentType.TAX_DECLARATION, List.of(FileFormat.PDF, FileFormat.DOCX));
