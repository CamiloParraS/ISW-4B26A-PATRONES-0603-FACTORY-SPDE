...
/**
 * Concrete Product — processes Financial Report documents.
 * Business logic will be implemented in Phase 3.
 *
 * Instantiated by each country factory via the Factory Method.
 */
public class FinancialReportProcessor implements DocumentProcessor {
    ...
    public ProcessingResult process(File file) {
        // TODO (Phase 3): Implement financial report processing logic
        throw new UnsupportedOperationException("FinancialReportProcessor.process() not yet implemented — Phase 3");
    }
    ...
    public String getDescription() {
        return "Processes Financial Report documents for " + country.getFullName();
    }
}
