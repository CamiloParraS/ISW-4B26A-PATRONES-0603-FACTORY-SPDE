...
public class ProcessingResult {
    ...
    public String toDisplayString() {
        ...
        return String.format(
                "┌%n" + "  ID       : %s%n" + "  Document : %s%n" + "  Country  : %s%n"
                        + "  Type     : %s%n" + "  Format   : %s%n" + "  Status   : %s%n"
                        + "  Message  : %s%n" + "  Size     : %d bytes%n" + "  Time     : %s%n",
                documentId, documentName, country.name(), documentType.getDisplayName(),
                fileFormat.getExtension(), status.name(), message, fileSizeBytes,
    ...
    public static class Builder {
        ...
        public Builder documentType(DocumentType type) {
            this.documentType = type;
            return this;
        }

        public Builder fileFormat(FileFormat format) {
        ...
        public Builder fileSizeBytes(long size) {
        ...
        public ProcessingResult build() {
            ...
            if (documentType == null)
                throw new IllegalStateException("documentType is required");
            if (fileFormat == null)
